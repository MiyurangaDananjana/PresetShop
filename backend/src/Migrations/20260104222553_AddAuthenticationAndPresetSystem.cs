...
{
    /// <inheritdoc />
    public partial class AddAuthenticationAndPresetSystem : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PresetFileUrl = table.Column<string>(type: "text", nullable: true),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Presets_Categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Purchases_Presets_PresetId",
                        column: x => x.PresetId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Presets_CategoryId",
                table: "Presets",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_Purchases_PresetId",
                table: "Purchases",
                column: "PresetId");
